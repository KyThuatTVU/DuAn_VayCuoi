        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            ...
            <div class="flex justify-center">
                <a 
                    ...
                    class="flex items-center justify-center gap-2 px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors w-full max-w-xs"
                >
                    ...
                    <span class="text-sm font-medium text-gray-700">Đăng nhập với Google</span>
                </a>
            </div>
