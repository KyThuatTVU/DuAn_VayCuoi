                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="tel:<?php echo $phone_link; ?>" class="inline-flex items-center gap-2 bg-pink-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-pink-700 transition">
